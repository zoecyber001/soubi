/**
 * TacticalCard - The core UI element representing a tool
 * Visual representation of an asset with status indicator
 * Features: Draggable, glowing neon borders, cyber cut corners, loadout support
 */
...
export default function TacticalCard({ 
  ...
  // Handle card click (fallback for non-drag interaction)
  ...
  // Drag overlay style (the ghost card following cursor)
